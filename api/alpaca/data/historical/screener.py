...
class ScreenerClient(RESTClient):
    ...
    def get_most_actives(self, request_params: MostActivesRequest) -> Union[RawData, MostActives]:
    ...
    def get_market_movers(self, request_params: MarketMoversRequest) -> Union[RawData, Movers]:
